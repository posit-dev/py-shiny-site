    ...
    - title: UI Object
      ...
      details: |
        ...
        <ol>
          ...
          <li>Decorate the function with `@render.ui`. If you're using a button or other element to show or hide the UI element, you'll also need to decorate with `@reactive.event`.</li>
        </ol>
        
      variations:
        - title: Update an input
          description: The previous example demonstrated how to show or hide a UI element. You can also use `ui.output_ui()` to update an existing input.
