...
- id: variations
  ...
  - title: Get brused points
    description: "Captures the brushed point(s) in Altair and reactively displays the dataframe data. The hovered point is an [Altair `IntervalSelection` object](https://altair-viz.github.io/user_guide/interactions/jupyter_chart.html#interval-selections)"
    apps:
    - title: Preview
      file: app-variation-hover-point-express.py
      height: 720
