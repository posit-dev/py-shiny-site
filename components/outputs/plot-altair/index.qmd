...
- id: variations
  ...
  - title: Basic JupyterChart example
    description: "Shows how to access the Altair JupyterChart object from shiny using the `.widget` attribute of the `render_altair` object. This is the basic entry point that shows the interface between Altair and Shiny so you are able to follow along the [Altair JupyterChart documentation](https://altair-viz.github.io/user_guide/interactions/jupyter_chart.html)"
    apps:
    - title: Preview
      file: app-variation-basic-express.py
      height: 720
    - title: Express
      file: app-variation-basic-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-basic-core.py
      shinylive:
      height: 720
  ...
  - title: Accessing and observing variable parameters
    description: "Demonstrates how to access and observe variable parameters from an Altair plot in Shiny. This example shows how to capture changes in variable parameters and reactively update the Shiny app based on those changes."
    apps:
    - title: Preview
      file: app-variation-variable-access-express.py
      height: 720
    - title: Express
      file: app-variation-variable-access-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-variable-access-core.py
      shinylive:
      height: 720

  - title: Setting variable parameters
    description: "Builds on the update variation to show Shiny components updating and modifying an Altair JupyterChart object."
    apps:
    - title: Preview
      file: app-variation-variable-set-express.py
      height: 720
    - title: Express
      file: app-variation-variable-set-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-variable-set-core.py
      shinylive:
      height: 720

  - title: Point selection parameter with legend
    ...
    apps:
    - title: Preview
      file: app-variation-selection-point-legend-express.py
      height: 720
    - title: Express
      file: app-variation-selection-point-legend-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-selection-point-legend-core.py
      shinylive:
      height: 720

  - title: Index selection parameter with hover
    ...
    apps:
    - title: Preview
      file: app-variation-selection-index-hover-express.py
      height: 720
    - title: Express
      file: app-variation-selection-index-hover-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-selection-index-hover-core.py
      shinylive:
      height: 720

  - title: Interval selection parameter with brush
    ...
    apps:
    - title: Preview
      file: app-variation-selection-interval-brush-express.py
      height: 720
    - title: Express
      file: app-variation-selection-interval-brush-express.py
      shinylive:
      height: 720
    - title: Core
      file: app-variation-selection-interval-brush-core.py
      shinylive:
      height: 720
---
...
We can do that with the [`JupyterChart`](https://altair-viz.github.io/user_guide/interactions/jupyter_chart.html) representation of the Altair figure.
In shiny,
...
which can be reactively read into Shiny using the `shinywidgets.reactive_read()` function.
