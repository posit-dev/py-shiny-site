...
- id: variations
  ...
  - title: Create dependent controls
    description: 'You can use `@render.ui()` and `ui.output_ui()` to create a set
      of controls that

      are dependent on a setting in your app. In this example, we show a different
      set

      of options when the app is in "plot" or "table" mode.
