...
preview: |
  <div class="px-3">
  <img style="width: 100%;" src="/images/verbatim.gif">
  </div>
listing:
  id: component
  ...
  contents:
    - title: Verbatim Text
      ...
      details: |
        ...
        To create reactive verbatim text, render the text in the server function with the decorators `@render.text`, just as you would to display [normal text](TODO: ADD LINK TO TEXT). Then place the rendered text in the ui with `ui.output_verbatim_text()`.
        ...
        See [Text](TODO: ADD LINK TO TEXT) to display string values as normal text.
