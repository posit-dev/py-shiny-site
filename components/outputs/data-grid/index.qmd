...
- id: variations
  ...
  - title: Update Row Selection
    description: 'The selected rows can be programmatically updated using
      ...
      to set `selection_mode` in `render_data_grid()` to `"row"` or `"rows"`, since
      it is `"none"` by default. '
    apps:
    - title: Preview
      file: app-variation-update-selection-core-preview.py
      height: 350
    - title: Express
      file: app-variation-update-selection-express.py
      shinylive: https://shinylive.io/py/app/#code=-PAsmCppwC6q+ub294Ht8en2JfXa28sljQSZFAQhHApAdhqMFMBUhcWABaQ5beY7RYsABUSJYACYWABqFig4DYSEwx7WbCIlHo0mogAMGAArPIPrNiBJAU0aJZdgcvj8--J8xEsNYlHaQp3bhmQVEKBYrAAD4sAAcqQWEHIYjSNrw1iPCKZkfDQJGWT4UjOd0VE0eZn7iHmUDJtIvESORChVKgKEUN5N7bgJmlRKQwwgKcZAiDmVGScQeanKEZXSacVHABcAC+iIRR8N7MuF8kfF2UnypYardL0-SDCMpF8SwpyTtOs5PgulXjROwE7hB7gHnNDCDM1nWdp+UAxXFo2JWMKVpXAGVbtY2VCXlBVgEV2i1fNUlzdVMlUT1bJNX5EBgA1FxAA
      height: 350
    - title: Core
      file: app-variation-update-selection-core.py
      shinylive: https://shinylive.io/py/app/#code=-eP2K93icgSxLDQJGQoBBCKkbp1lgpgGsXiwALS3C57K7dFgAKlxLAATCwANQsBHAbAo9G--p2Kw9IgLCCSJJ4sEqKpchuW4YAAIvWADijBCp0ElzohcB5Iur5PnADSPMoADuTjYbJwmiRAbHZLk+RFBgg4KMZrByU53KSNg0KgoOLDWNJDnySuMGumQMkWi0rAAD4sAAcqQcA3BOkQ7rw1i-D0kX+bhPhTAwiw+FI6UzDJfkKQF1lQIG0jtI4XYKBgeioNxZowoB1h8pGJmkJ0ICPGQIhRkgLBWcQ1nRjNYA2XZMnAC8AC+OJ1dFpyIXytWOfVpw2VqNwzFAczleQEj6a1RjBI8j7Pq+aEfgtj2UcBdHuOBC1XWQW2HTtuFQI1zUSe1nXdRwvWIUBg0+Yuo3jZNjwybN834Ity1o4pc1aptRU6ugNyBKgnS6vqNCGSO5S9mA60vEAA
      height: 350
