...
See also: [Verbatim Text](../verbatim-text/index.qmd) and [Text](../text/index.qmd) for other ways to display text output, and [Code Editor](../../inputs/code-editor/index.qmd) for letting the user *write* code rather than read it.
