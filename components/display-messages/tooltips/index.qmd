...
- id: example
  ...
  - title: Core
    file: app-core.py
    shinylive: https://shinylive.io/py/editor/#code=-rU4K8bEjRqEpBQFAxVnQ8gAVNzzdBsChQKgoEBgihYaazBkNYkAXzySxGajFGj0YkwNg02k4MKBci+EByYAouHQCBQasJFDAAoAukA
...
See Also: [Modal messages](../../layout/modal/index.qmd) and [notications](../notifications/index.qmd) provide a similar, but alternative way to display information to the user.
