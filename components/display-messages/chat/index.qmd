...
- id: relevant-functions
  ...
  - title: ui.chat_ui
    href: https://shiny.posit.co/py/api/core/ui.chat_ui.html#shiny.ui.chat_ui
    signature: ui.chat_ui(id, *, greeting=None, placeholder='Enter a message...',
      drawer=True, footer=None, toolbar_input=None, show_history=True, show_thinking_after_s=0,
      width='min(clamp(680px, 50vw, 760px), 100%)', height='auto', fill=True, icon_assistant=None,
      icon_send=None, enable_cancel=MISSING, submit_key='enter', allow_attachments=MISSING,
      tool_grouping='tool', messages=None, **kwargs)
