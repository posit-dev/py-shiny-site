...
- id: relevant-functions
  ...
  - title: ui.chat_ui
    ...
    signature: ui.chat_ui(id, *, messages=None, greeting=None, placeholder='Enter
      a message...', width='min(680px, 100%)', height='auto', fill=True, icon_assistant=None,
      enable_cancel=MISSING, submit_key='enter', allow_attachments=MISSING, footer=None,
      **kwargs)
  - title: chat = ui.Chat()
