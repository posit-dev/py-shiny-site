  ...
  contents:
    - title: Numeric Input
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_numeric()` to the UI of your app to create a div in which to display the input. Where you call this function will determine where the numeric input control will appear within the app's layout. 
          </li>
          <li>
        ...
        <p>To access the value of the numeric input control:</p>
