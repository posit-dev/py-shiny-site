...
preview: |
  ...
  <select id="x" class="form-select shiny-bound-input">            
  <option value="a" selected="">We're halfway there</option>
  <option value="b">Whoa oh, livin' on a prayer</option>
  <option value="c">Take my hand</option>
  <option value="d">We'll make it, I swear</option>
  <option value="e">Whoa oh, livin' on a prayer</option>
  </select>
  </div>
listing:
  id: component
