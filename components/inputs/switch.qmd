  ...
  contents:
    - title: Switch
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_switch()` to the UI of your app to create a div in which to display the switch. Where you call this function will determine where the switch will appear within the app's layout. 
          </li>
          <li>
        ...
        <p>To access the value of a switch:</p>
