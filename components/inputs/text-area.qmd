  ...
  contents:
    - title: Text Area
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_text_area()` to the UI of your app to create a div in which to display the textarea. Where you call this function will determine where the textarea will appear within the app's layout. 
          </li>
          <li>
        ...
        <p>To access the value of a textarea:</p>
