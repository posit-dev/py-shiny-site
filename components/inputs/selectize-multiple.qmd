  ...
  contents:
    - title: Selectize (Multiple)
      ...
      details: |
        ...
        <p>The currently selected value of the selectize list is accessible as a reactive value within the server function. To access the value of a selectize list:</p>
        ...
        <p>See also: Selectize (Single) (TODO: ADD LINK TO Selectize (Single) HERE) and Select (Multiple) (TO DO ADD SELECT MULTIPLE LINK HERE). The Select Input is similar to the Selectize Input, but _________.</p>
---
