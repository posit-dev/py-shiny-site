    ...
    - title: Selectize (Multiple)
      ...
      details: |
        ...
        <ol>
          ...
          You can also supply with `choices` a dictionary of dictionaries. `ui.input_selectize()` will use the top-level keys as group labels (see <em>Selectize</em> with grouped choices below).
          </li>
          <li>
