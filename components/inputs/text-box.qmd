  ...
  contents:
    - title: Text Box
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_text()` to the UI of your app to create a div in which to display the text box. Where you call this function will determine where the text box will appear within the app's layout. 
          </li>
          <li>
        ...
        <p>To access the value of a text box:</p>
