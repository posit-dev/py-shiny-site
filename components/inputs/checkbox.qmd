  ...
  contents:
    - title: Checkbox
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_checkbox()` to the UI of your app to create a div in which to display the checkbox. Where you call this function will determine where the checkbox will appear within the app's layout. 
          </li>
          <li>
          ...
          <li>
          Access the value of your checkbox with `input.<checkbox_id>()` (e.g., `input.checkbox()`). The server value of a checkbox is `True` if checked and `False` if not checked. 
          </li>
        </ol>
