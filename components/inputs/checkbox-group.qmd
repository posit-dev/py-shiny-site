    ...
    - title: Checkbox Group
      ...
      details: |
        ...
        <ol>
          ...
          <li>
          Access the value of your checkbox group with `input.<checkbox_group_id>()` (e.g., `input.checkbox_group()`). The server value of a checkbox group is a tuple of string(s) with the selected value(s). 
          </li>
