  ...
  contents:
    - title: Action Link
      ...
      details: |
        ...
        <ol>
          <li>
          Add `ui.input_action_link()` to the UI of your app to create the action link. Where you call this function will determine where the link will appear within the app's layout.
          </li>
          <li>
          Access the value of your action link with `input.<action_link_id()`> (e.g., `input.action_link()`). The server value of an action link is an integer representing the number of clicks. 
          </li>
        </ol>
