    ...
    - title: Action Button
      ...
      details: |
        ...
        <ol>
          ...
          <li>Access the value of your action button with `input.<action_button_id()>` (e.g., `input.action_button()`). The server value of an action button is an integer representing the number of clicks. 
          </li>
        </ol>
