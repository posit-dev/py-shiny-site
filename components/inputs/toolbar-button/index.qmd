...
4. Set `show_label=True` to display both the label text and icon.
...
- Cannot update `tooltip` or `border` after creation (use `ui.update_tooltip()` to update tooltip text)
