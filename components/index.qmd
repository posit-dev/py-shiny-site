...
::::{.grid style="height:500px;border-bottom:1px solid;"}
...
::: {.grid style="border-top: 1px solid #ccc;padding-top:5rem;padding-bottom:5rem;margin-top: -1px;"}
...
:::
:::
<div class="g-col-lg-9 g-col-12 pt-3 ps-0 ps-lg-5 ms-0 ms-lg-4">
...
<h2 class="mt-4"> <i class="bi bi-chat-right-dots-fill indigo"></i> Display Messages </h2>
