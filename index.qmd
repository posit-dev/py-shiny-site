...
:::{.grid}
:::{.g-col-12 .g-col-xl-6 .hero-text .pt-5 .px-3 .px-md-5 .pe-xl-0}
...
::::{.column-screen-inset .pt-5 .mt-5 .mx-auto style="max-width:1200px;"}
:::{.grid}
...
This efficient execution method means that you can use a single framework to create anything from a simple dashboard to a full-featured web applications.
...
::: {.text-center .py-5 style="z-index:1;"}
...
:::: {.mx-auto style="max-width: 675px;"}

## Shiny apps are easy to blah blah blah:
...
See how to make this dashboard [your own](https://shiny.posit.co/py/docs/user-interfaces.html#sophisticated-dashboard){.white .fw-bold}.
:::
:::
