...
<p class="mb-0">Use [your data](https://www.youtube.com/watch?v=ou-09NHcH5w){.white .fw-600} and make the layout [your own](https://shiny.posit.co/py/docs/user-interfaces.html#sophisticated-dashboard){.white .fw-600}.</p>
:::
:::
