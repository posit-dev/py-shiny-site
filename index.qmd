...
<div id="carouselExampleCaptions" class="carousel carousel-dark carousel-fade slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item bg-white shadow p-3 active">
      <a href="https://gallery.shinyapps.io/template-monitor-database/">
        <img src="/images/model-monitoring-dashboard.jpg" class="d-block" alt="A screenshot of a dashboard app, with controls on the left, four numeric metrics displayed at the top, and two large plots filling the rest of the image.">
      </a>
      <div class="carousel-caption">
        <p>Create powerful <a href="https://gallery.shinyapps.io/model-score/">metrics dashboards</a> that update in realtime, <a href="/templates/monitor-database/index.qmd">also available as a template</a>.</p>
      </div>
    </div>
