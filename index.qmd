...
::::{.column-screen .mx-auto .pt-0 .mt-0 .pt-lg-5  style="max-width: 1600px;"}
:::{.grid}
...
:::{.g-col-12 .g-col-md-6 .g-col-xl-3 .mx-3 .mx-md-4 .mx-lg-4 .feature-section}
...
::: {.column-screen .bg-dark-blue .mb-0 .px-3 .px-md-5 }

::: {.pt-5 .pb-5 .mx-auto style="max-width:1600px;"}

## Here is a Shiny app {.fw-600}  

<p class="fw-400 h5 mt-0">Shiny apps are easy to write. Let users interact with your data and analysis:</p>
...
::: {.grid .pt-4}
::: {.g-col-12 .g-col-xl-5 }
```python {filename="app.py" class="example-app" style="overflow:scroll;margin-bottom: 0.5rem;font-weight:400;"}
...
::: {.hello-output .g-col-12 .g-col-xl-7}
<iframe
...
:::::: {.column-screen .py-5 .bg-dark-blue .mb-0 .px-3 .px-md-5 }

::::: {.column-body}

::: {.mx-auto}

## Shiny apps are easy to begin.  run these commands to make your first app:
<div style="display: flex;
  align-items: baseline;">
<p class="mb-0 big-blue-text white">1.</p>
  <p class="after-big-blue-text d-inline-block mb-4 h4"><code style="background-color:transparent;">pip install shiny</code></p>
</div>
<p class="mb-0 big-blue-text white">2.</p>
<p class="after-big-blue-text d-inline-block mb-4 h4"><code style="background-color:transparent;">shiny create &ndash;&ndash;template dashboard-tips</code></p>
...
::::::
::::::
::::: {.column-screen .hero-image style="margin-top:0px;max-width:1600px;"}
::: {.hello-output .g-col-12 .g-col-xl-12}
<iframe
  src="https://gallery.shinyapps.io/template-stock-app/"
  frameborder="0"
  width="100%"
  class="mb-0 card"
  style="height: 900px;"
...
:::{.column-screen .hero-image  style="z-index:0;margin-top:unset;"}
```{=html}
