...
To place an underlined tabset inside a card, use `ui.navset_card_underline()` instead. And if you want to control the visible panel programmatically, without showing any navigation controls, use `ui.navset_hidden()` together with `ui.update_navset()`.
