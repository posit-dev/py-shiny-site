...
<h2 class="mt-4">
  <a href="panels-cards" class="dark text-decoration-none">
    <img alt="" src="/images/cards-blue.svg" class="me-2" style="height: 34px;margin-bottom:7px;">Cards & Panels
  </a>
</h2>

Use cards and panels to define areas of related content.

<a href="panels-cards" class="fw-500">Learn Cards & Panels <i class="bi bi-chevron-right"></i></a>
:::
::::
:::: {.g-col-xl-9 .g-col-12 .pt-3 .pt-xl-5 .ps-0 .ps-xl-5 .ms-0 .ms-xl-4}
::: {#panel .grid}
