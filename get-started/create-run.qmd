...
Running a Shiny app in Positron launches a Python process in a dedicated terminal instance and opens the app in an internal web browser, letting you test your app without leaving your editor. 
Whenever you make changes to your app's source, the preview will update. 
To preview your app in a full browser, click the icon to the right of the URL bar to open the app in an external browser.
