...
For more advanced needs, you can develop a [reusable component package](/docs/custom-components-pkg.qmd) or [customize the user interface](/docs/ui-customize.qmd) by incrementally [adding JavaScript](/docs/custom-component-one-off.qmd), [HTML](/docs/ui-html.qmd), or even [WebAssembly](/get-started/shinylive.qmd), without needing to learn complex build tools or frameworks.
