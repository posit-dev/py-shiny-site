...
### shinyapps.io
  ...
  2. The best place to get community support for shinyapps.io is the [shinyapps.io category on Posit Community](https://forum.posit.co/tag/shinyappsio){target="_blank"}. If you're having difficulties with shinyapps.io, feel free to ask questions there. Another option is to file an issue in the [rsconnect-python package repo](https://github.com/posit-dev/rsconnect-python/issues){target="_blank"}.
