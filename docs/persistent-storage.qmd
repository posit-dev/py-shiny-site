...
Allowing users to read and write from a database, particularly using SQL, opens up a potential vector for attackers. Follow commonly accepted best practices for avoiding SQL injection attacks like using prepared statements instead of string concatenation.
