...
def submit_data():
    info = {
        ...
        # We convert the boolean checkbox value to a string for storage
    ...
    try:
        ...
        ui.notification_show(f"Error submitting: {e}", type="error")
...
def save_info(info: dict):
    ...
    new_row = [info["name"], info["checkbox"], info["favorite_number"]]
