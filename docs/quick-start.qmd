...
Next, we'll learn how to create [dashboards](dashboards.qmd) and more about Shiny's [Jupyter Widgets](jupyter-widgets.qmd) integration.
If you want to start developing Shiny apps locally, skip ahead to the [workflow articles](install-create-run.qmd).
