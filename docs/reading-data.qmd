...
Now that you have data in your application, it's worthwhile to consider reading up on a few topics. You might consider this article on [mutability](https://shiny.posit.co/py/docs/reactive-mutable.html). This is likely to come up as you store and update filtered datasets.

You might also consider visiting our sections on [reactivity](https://shiny.posit.co/py/docs/reactive-foundations.html) as you think about how filtering your dataset should affect your other outputs.
