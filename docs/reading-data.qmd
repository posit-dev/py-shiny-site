...
Polars also supports lazy reading from cloud storage using its query optimization tooling. This is very helpful for limiting how much information is downloaded, especially if you only need a small portion of a much larger dataset for your application (ex. You have data from 1900-present but you only need 2000-present.)
