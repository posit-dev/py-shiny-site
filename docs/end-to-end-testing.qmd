...
Test mode requires a version of Shiny newer than 1.6.3. If it isn't in a release yet, install the development version with `pip install git+https://github.com/posit-dev/py-shiny.git`.
:::
