...
Notice that the slider's value is the *integer* `20` here, while the controller example earlier asserted the *string* `"55"`. That's because the two read from different places:
