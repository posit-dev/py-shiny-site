...
The images below show a Shiny app (left) that uses Generative AI to provide weather forecasts, and an example trace in Logfire (right). The trace captures the entire user session, including reactive updates, model calls, and a tool invocation. We will explore this example in more detail later in the article.
