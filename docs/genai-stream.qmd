...
```bash
uvx shiny create --template stream-ai-ollama
```

### Anthropic

```bash
uvx shiny create --template stream-ai-anthropic
```

### OpenAI

```bash
uvx shiny create --template stream-ai-openai
```

### Google

```bash
uvx shiny create --template stream-ai-gemini
```

### Bedrock Anthropic

```bash
uvx shiny create --template stream-ai-anthropic-aws
```

### Azure OpenAI

```bash
uvx shiny create --template stream-ai-azure-openai
```

### LangChain

```bash
uvx shiny create --template stream-ai-langchain
```
