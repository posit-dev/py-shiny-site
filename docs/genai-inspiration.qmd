...
The repo defaults to the `tips` dataset, but without much effort, you can adapt it to another dataset of your choosing.
[See here](https://jcheng.shinyapps.io/sidebot/) for a hosted version of the app.
