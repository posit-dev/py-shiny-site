...
In this article, we only cover the most common input objects.
If you're curious to see more, checkout the [inputs section of the components gallery](../components/#inputs).
:::
