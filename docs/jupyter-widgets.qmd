...
```bash
uv pip install altair bokeh plotly ipyleaflet pydeck==0.8.0
```
...
first try running this "hello world" ipywidgets [example](https://github.com/posit-dev/py-shinywidgets/blob/main/examples/ipywidgets/app.py).
