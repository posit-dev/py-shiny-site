...
Fortunately, it's straightforward to [transition](express-to-core.qmd) from Express to Core since many of the foundations (i.e., [components](ui-overview.qmd), [reactivity](reactive-foundations.qmd), etc.) are the same.
