...
For example, if you want to move pieces of the UI code to another file you can do that either by storing them in variables, or using Shiny [modules](modules.qmd).
