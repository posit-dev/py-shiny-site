...
Shiny Express code that works via side-effects needs to be used with `@render.display`, not `@render.ui`. See [this section](express-motivation.qmd#reactive-express-displays) to learn more.
:::
