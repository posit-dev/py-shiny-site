...
It is required for output decorator functions to be `async`. This allows users of the render bindings to provide either synchronous or asynchronous functions to the decorator. This allows us to write our code in a way that is agnostic to how the user has written their render function.
