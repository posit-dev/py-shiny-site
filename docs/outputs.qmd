...
In this article, we only cover the most common output objects.
If you're curious to see more, checkout the [outputs section of the components gallery](../components/#outputs).
:::
