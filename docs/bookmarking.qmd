...
See the [Bookmark Button](/components/inputs/bookmark-button/index.qmd) component page for the button's own options (label, icon, tooltip) and for how to use more than one bookmark button in a single app.
