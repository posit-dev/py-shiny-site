...
TODO: RElocate items to appropriate files; Make bullets `*`

1. (For `core` more only) **Always make your UI a function** that accepts a `Request` parameter - this is required for bookmarking to work.
...
- **File uploads**: File inputs should not be bookmarked with URL storage. With server storage, you need custom logic to save/restore files.

- **Security**: URL bookmarks are visible to users / their browser. Don't include sensitive information in URL bookmarks.
