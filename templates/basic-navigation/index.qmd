...
## Express
``` bash
uvx shiny create --template basic-navigation --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template basic-navigation --mode core --github posit-dev/py-shiny-templates
```
:::
