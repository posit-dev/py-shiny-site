...
## Express
``` bash
uvx shiny create --template regularization --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template regularization --mode core --github posit-dev/py-shiny-templates
```
:::
