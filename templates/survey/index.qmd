...
## Express
``` bash
uvx shiny create --template survey --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template survey --mode core --github posit-dev/py-shiny-templates
```
:::
