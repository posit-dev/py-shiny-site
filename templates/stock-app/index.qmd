...
## Express
``` bash
uvx shiny create --template stock-app --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template stock-app --mode core --github posit-dev/py-shiny-templates
```
:::
