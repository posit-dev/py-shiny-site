...
## Express
``` bash
uvx shiny create --template dashboard --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template dashboard --mode core --github posit-dev/py-shiny-templates
```
:::
