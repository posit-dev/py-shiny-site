...
## Express
``` bash
uvx shiny create --template nba-dashboard --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template nba-dashboard --mode core --github posit-dev/py-shiny-templates
```
:::
