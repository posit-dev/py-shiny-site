...
## Express
``` bash
uvx shiny create --template dashboard-tips --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template dashboard-tips --mode core --github posit-dev/py-shiny-templates
```
:::
