...
## Express
``` bash
uvx shiny create --template basic-sidebar --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template basic-sidebar --mode core --github posit-dev/py-shiny-templates
```
:::
