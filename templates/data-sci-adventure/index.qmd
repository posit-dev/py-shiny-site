...
## Express
``` bash
uvx shiny create --template data-sci-adventure --mode express --github posit-dev/py-shiny-templates/gen-ai
```
## Core
``` bash
uvx shiny create --template data-sci-adventure --mode core --github posit-dev/py-shiny-templates/gen-ai
```
:::
