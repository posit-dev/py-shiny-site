...
## Express
``` bash
uvx shiny create --template monitor-folder --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template monitor-folder --mode core --github posit-dev/py-shiny-templates
```
:::
