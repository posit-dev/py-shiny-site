...
## Express
``` bash
uvx shiny create --template monitor-file --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template monitor-file --mode core --github posit-dev/py-shiny-templates
```
:::
