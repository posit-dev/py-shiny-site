...
## Express
``` bash
uvx shiny create --template dinner-recipe --mode express --github posit-dev/py-shiny-templates/gen-ai
```
## Core
``` bash
uvx shiny create --template dinner-recipe --mode core --github posit-dev/py-shiny-templates/gen-ai
```
:::
