...
## Express
``` bash
uvx shiny create --template basic-app-plot --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template basic-app-plot --mode core --github posit-dev/py-shiny-templates
```
:::
