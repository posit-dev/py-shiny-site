...
## Express
``` bash
uvx shiny create --template workout-plan --mode express --github posit-dev/py-shiny-templates/gen-ai
```
## Core
``` bash
uvx shiny create --template workout-plan --mode core --github posit-dev/py-shiny-templates/gen-ai
```
:::
...
* [Download button](/api/express/express.render.download_button.html)
