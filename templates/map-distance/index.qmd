...
## Express
``` bash
uvx shiny create --template map-distance --mode express --github posit-dev/py-shiny-templates
```
## Core
``` bash
uvx shiny create --template map-distance --mode core --github posit-dev/py-shiny-templates
```
:::
