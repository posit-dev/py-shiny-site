...
## Express
``` bash
uvx shiny create --template basic-chat --mode express --github posit-dev/py-shiny-templates/gen-ai
```
## Core
``` bash
uvx shiny create --template basic-chat --mode core --github posit-dev/py-shiny-templates/gen-ai
```
:::
