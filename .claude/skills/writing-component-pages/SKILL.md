...
|------|-------------|-------|
| `app-preview.py` | Gallery-list card (via `appPreview:` + `make docs-static-previews`) | Core, module-level `app_ui`, viewport-filling (`vh-100 d-flex justify-content-center align-items-center`) |
